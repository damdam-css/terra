...
export const TerraCycle: React.FC = () => {
  const [projects, setProjects] =
    useState<UpcycleProject[]>(UPCYCLE_PROJECTS);
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      onClick={(e) =>
                        handleLike(proj.id, e)
                      }
                      className="flex items-center gap-1 bg-[#FEF9E7] border border-[#1D3557]/30 hover:border-[#1D3557] px-2.5 py-1 rounded-xl text-xs font-medium text-[#1D3557] shadow-xs active:scale-95 transition-transform"
                    >
                      <Heart
