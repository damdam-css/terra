        ...
        <div className="min-h-[76px] py-3 flex items-center justify-between gap-4">
          ...
          >
            ...
            <div className="hidden sm:block">
              <div className="flex items-center gap-2">
                <span className="font-heading font-black text-[25px] leading-none tracking-wide text-[#1D3557]">
                  TERRA
                </span>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              type="button"
              onClick={onLogin}
              className="hidden sm:flex items-center gap-1.5 border-2 border-[#1D3557] bg-white rounded-xl px-3 py-2 font-heading font-bold text-xs hover:bg-[#BDE0FE]"
            >
            ...
            <button
              type="button"
              onClick={onRegister}
              className="hidden sm:flex items-center gap-1.5 border-2 border-[#1D3557] bg-[#C7F9CC] rounded-xl px-3 py-2 font-heading font-bold text-xs shadow-[0_3px_0_0_#1D3557] hover:-translate-y-0.5"
            >
              Daftar
            </button>
            ...
            {/* Earth XP */}
            <div
              className="flex items-center gap-2 bg-white border-2 border-[#1D3557] px-2.5 sm:px-3 py-2 rounded-xl shadow-[0_3px_0_0_#1D3557]"
              title="Eco-XP didapat dari menyelesaikan modul edukasi dan scan sampah"
            >
              <div className="w-7 h-7 rounded-lg bg-[#FFF176] border border-[#1D3557]/30 flex items-center justify-center">
                <Trophy
              ...
              <div className="hidden sm:flex flex-col">
                <span className="text-[8px] uppercase font-bold text-[#1D3557]/50 leading-none tracking-wide">
                  Earth XP
                </span>

                <span className="font-heading font-black text-xs text-[#1D3557] leading-tight mt-0.5">
                  {ecoXp}{' '}
              ...
              {/* Compact XP value for small screens */}
              <span className="sm:hidden font-heading font-black text-[11px] text-[#1D3557]">
                {ecoXp}
              </span>
            </div>
