...
interface TerraEduProps {
  ...
  currentRole?: 'siswa' | 'petugas' | 'admin' | null;
}
...
export const TerraEdu: React.FC<TerraEduProps> = ({
  ...
  const canManageEducation = currentRole === 'admin';
          ...
          {modules.map((mod, index) => {
            ...
            return (
              ...
              >
                ...
                {canManageEducation && mod.isCustom && onDeleteModule && (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      ...
                      <div className="font-heading font-black text-sm mb-1 flex items-center gap-2">
                        {selectedQuizOption === selectedModule.quiz.correctIndex ? (
                          <>
                            ...
                            <span>Jawaban Benar! Progres tersimpan.</span>
                          </>
                        ) : (
                          <>
