    ...
    mode === 'register'
      ...
      : mode === 'forgot'
        ...
        : mode === 'reset'
          ...
          : 'Masuk untuk lanjut belajar dan mengumpulkan Earth-XP.';
    ...
    <div className="min-h-screen bg-[#FAF9F5] text-[#1D3557] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg relative">
        ...
        <div className="bg-white border-[3px] border-[#1D3557] rounded-3xl p-6 sm:p-8 shadow-[0_8px_0_0_#1D3557]">
              ...
              <div className="rounded-xl border border-blue-200 bg-blue-50 p-3">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="text-xs text-blue-900">
                    ...
                    <div>
                      Akun yang dibuat melalui
                      pendaftaran ini otomatis
                      menggunakan role
                      <strong> siswa</strong>.
                    </div>

                    <div className="mt-1">
                      Admin dan petugas tidak dapat
                      mendaftar melalui halaman ini.
                    </div>
          ...
          {mode === 'register' && (
            <div className="mt-5 rounded-xl bg-[#F5F7F2] p-3 text-[11px] text-center opacity-75">

              <div>
                Pendaftaran publik hanya membuat
                akun dengan role{' '}
                <strong>siswa</strong>.
              </div>

              <div className="mt-1">
                Role admin dan petugas dikelola
                oleh pihak sekolah.
              </div>
